        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <div class="box">
                        <div class="box-body">
                            <img class="profile-user-img img-responsive transition03 img-circle" src="{{ asset('assets/site/images/user.png') }}" alt="User profile picture">
                                ...
                                {{--<ul class="timeline timeline-inverse">--}}
                                    ...
                                    {{--<li>--}}
                                        ...
                                        {{--<div class="timeline-item">--}}
                                            ...
                                            {{--<div class="timeline-body">--}}
                                                {{--<img src="placehold.it/150x100" alt="..." class="margin">--}}
                                                {{--<img src="placehold.it/150x100" alt="..." class="margin">--}}
                                                {{--<img src="placehold.it/150x100" alt="..." class="margin">--}}
                                                {{--<img src="placehold.it/150x100" alt="..." class="margin">--}}
                                            {{--</div>--}}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-6">
                                                    <div class="form-group has-feedback">
                                                        ...
                                                        {!! Form::text('phone', null, ['placeholder' => 'Digite seu telefone', 'class' => 'form-control cellphone']) !!}
                                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                </div>
