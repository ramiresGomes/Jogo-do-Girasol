  ...
  <div class="container-fluid" id="wrapper">
    <div class="panel panel-primary hidden-xs">
      <div class="panel-heading">
        <h1 class="panel-title">Gerenciador de Arquivos</h1>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-sm-10 col-xs-12" id="main">
        <nav class="navbar navbar-default" id="nav">
          <div class="navbar-header">
            ...
            <a class="navbar-brand visible-xs" href="#">Gerenciador de Arquivos</a>
          </div>
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a href="#" id="list-sort-alphabetic">
                      <i class="fa fa-sort-alpha-asc"></i> Ordem Alfabética
                    </a>
                  </li>
                  <li>
                    <a href="#" id="list-sort-time">
                      <i class="fa fa-sort-amount-asc"></i> Data de Criação
                    </a>
                  </li>
                </ul>
              </li>
      ...
      <ul id="fab">
        <li>
          ...
          <ul class="hide">
            <li>
              <a href="#" id="add-folder" data-mfb-label="Nova Pasta">
                <i class="fa fa-folder"></i>
              </a>
            </li>
            <li>
              <a href="#" id="upload" data-mfb-label="Enviar">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">Envio de Arquivo</h4>
        </div>
        <div class="modal-body">
          <form action="{{ route('unisharp.lfm.upload') }}" role='form' id='uploadForm' name='uploadForm' method='post' enctype='multipart/form-data'>
            <div class="form-group" id="attachment">
              <label for='upload' class='control-label'>Escolha um arquivo</label>
              <div class="controls">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" id="upload-btn">Enviar</button>
        </div>
      </div>
    </div>
  </div>
