  ...
  <div class="col-md-4">
    ...
    <table class="table table-compact table-striped">
      ...
      <tbody>
        ...
        @endif
        <tr>
          <td>Altura Original:</td>
          <td>{{ $original_height }}px</td>
        </tr>
        <tr>
          <td>Largura Original:</td>
    ...
    <button class="btn btn-primary" onclick="doResize()">Redimensionar</button>
    <button class="btn btn-info" onclick="loadItems()">Cancelar</button>
