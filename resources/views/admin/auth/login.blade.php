...
<head>
    ...
    <title>Jogo do Girasol | @lang('sunflower.admin.login.page-title')</title>
...
<body class="hold-transition login-page sunflower-wallpaper">
    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            <p class="login-box-msg">@lang('sunflower.admin.login.box-title')</p>
                ...
                <div class="row">
                    <div class="col-xs-8">
                        <a href="{{ url('/password/reset') }}" class="line-h34 text-black">
                            @lang('sunflower.admin.login.forgot-password')
                        </a>
                    </div>
                    ...
                    <div class="col-xs-4">
                        <button type="submit" class="btn btn-success btn-block btn-flat pull-right">
                            ...
                            @lang('sunflower.custom.button.sign-in')
                        </button>
                    </div>
                </div>
            {!! Form::close() !!}
